    ...
    <div class="flex flex-col justify-center items-center">
        <div class="flex flex-col justify-between items-center bg-white p-14 rounded-2xl shadow-md gap-4">
            <hgroup class="flex flex-col items-center gap-2">     
                <h1 class="font-medium text-2xl text-black">Login to Account</h1>
            ...
            <p class="flex gap-1 text-black">Don’t have an account?<NuxtLink to="/register" class="text-blue-500 underline decoration-solid">Create Account</NuxtLink></p>
        </div>
    </div>
</template>
